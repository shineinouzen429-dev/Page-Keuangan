...
const Dashboard = () => {
  ...
  const totalMasuk = tagihan.reduce((sum, item) => {
    if (item.status.toLowerCase() === "lunas") {
      const jumlah = parseInt(item.jumlah.replace(/[^\d]/g, ""));
      return sum + jumlah;
    }
    return sum;
  }, 0);
      ...
      <div className="w-full max-w-6xl p-6">
        <div className="flex flex-col items-center ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 w-full max-w-3xl">
            ...
            <div className="bg-gray-700 p-5 rounded shadow text-center">
              <h2 className="text-white text-lg font-semibold mb-2">Total Nominal Masuk</h2>
